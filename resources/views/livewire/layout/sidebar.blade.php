...
<!-- Sidebar Menu -->
<nav x-data="{ '!translate-x-0': open }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 fixed top-0 left-0 z-20 w-9/12 h-screen overflow-y-auto transition duration-300 ease-in-out transform -translate-x-full shadow-2xl sm:w-64 md:translate-x-0">
    <!-- Sidebar Header -->
    <div class="flex items-center h-20">
        <div class="inline-flex items-center justify-center w-full md:justify-center">
            ...
            <!-- Logo -->
            <a href="#">
                <h2 class="text-xl font-extrabold md:text-2xl border-gray-200 dark:border-gray-600 text-gray-800 dark:text-gray-200">{{ config('app.name', 'Laravel') }}</h2>
            </a>
        </div>
    </div>
    <!-- Profile Section -->
